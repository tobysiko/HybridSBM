...
#ifndef HamRepExRun_HH
#define HamRepExRun_HH
#include <Algorithms/HamRepEx.hh>
...
called \e HamRepExRun.mex, and there is no serial counterpart to this program.
...
other temperature set, you have to create a file and tell HamRepExRun.mex about
...
Something like:
\verbatim
mpirun -np 8 $profasi/app/bin/HamRepExRun.mex
\endverbatim
...
\verbatim
mpirun -np 8 $profasi/app/bin/HamRepExRun.mex -tmin 274 -tmax 374 -ntmp 8
\endverbatim
...
\verbatim
mpirun -np 8 $profasi/app/bin/HamRepExRun.mex --multiplexing
\endverbatim
...
/**
  * The HamRepExRun class adapts the BasicMCRun class to perform replica
  ...
  */
class HamRepExRun : public BasicMCRun
{
public:
    HamRepExRun();
    ~HamRepExRun();
